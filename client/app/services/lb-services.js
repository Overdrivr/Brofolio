  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Project.assets.findById() instead.
        "prototype$__findById__assets": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Projects/:id/assets/:fk",
          method: "GET"
        },

        // INTERNAL. Use Project.assets.destroyById() instead.
        ...
        // INTERNAL. Use Project.assets.updateById() instead.
        ...
        // INTERNAL. Use Project.assets() instead.
        "prototype$__get__assets": {
          isArray: true,
          url: urlBase + "/Projects/:id/assets",
          method: "GET"
        },

        // INTERNAL. Use Project.assets.create() instead.
        "prototype$__create__assets": {
          url: urlBase + "/Projects/:id/assets",
          method: "POST"
        },

        // INTERNAL. Use Project.assets.destroyAll() instead.
        "prototype$__delete__assets": {
          url: urlBase + "/Projects/:id/assets",
          method: "DELETE"
        },

        // INTERNAL. Use Project.assets.count() instead.
        "prototype$__count__assets": {
          url: urlBase + "/Projects/:id/assets/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Asset.project() instead.
        "::get::Asset::project": {
          url: urlBase + "/Assets/:id/project",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Project.assets
     * @header lbServices.Project.assets
     * @object
     * @description
     *
     * The object `Project.assets` groups methods
     * manipulating `Asset` instances related to `Project`.
     *
     * Call {@link lbServices.Project#assets Project.assets()}
     ...
     */
        ...
        R.assets = function() {
          ...
          var action = TargetResource["::get::Project::assets"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project.assets#count
         * @methodOf lbServices.Project.assets
         *
         * @description
         *
        ...
        R.assets.count = function() {
          var TargetResource = $injector.get("Asset");
          var action = TargetResource["::count::Project::assets"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project.assets#create
         * @methodOf lbServices.Project.assets
         *
         * @description
         *
        ...
        R.assets.create = function() {
          var TargetResource = $injector.get("Asset");
          var action = TargetResource["::create::Project::assets"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project.assets#createMany
         * @methodOf lbServices.Project.assets
         *
         * @description
         *
        ...
        R.assets.createMany = function() {
          var TargetResource = $injector.get("Asset");
          var action = TargetResource["::createMany::Project::assets"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project.assets#destroyAll
         * @methodOf lbServices.Project.assets
         *
         * @description
         *
        ...
        R.assets.destroyAll = function() {
          var TargetResource = $injector.get("Asset");
          var action = TargetResource["::delete::Project::assets"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project.assets#destroyById
         * @methodOf lbServices.Project.assets
         *
         * @description
         *
        ...
        R.assets.destroyById = function() {
          var TargetResource = $injector.get("Asset");
          var action = TargetResource["::destroyById::Project::assets"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project.assets#findById
         * @methodOf lbServices.Project.assets
         *
         * @description
         *
        ...
        R.assets.findById = function() {
          var TargetResource = $injector.get("Asset");
          var action = TargetResource["::findById::Project::assets"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project.assets#updateById
         * @methodOf lbServices.Project.assets
         *
         * @description
         *
        ...
        R.assets.updateById = function() {
          var TargetResource = $injector.get("Asset");
          var action = TargetResource["::updateById::Project::assets"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Project.assets.createMany() instead.
        "::createMany::Project::assets": {
          isArray: true,
          url: urlBase + "/Projects/:id/assets",
          method: "POST"
        },
    ...
    */
    R.modelName = "Asset";
        ...
        R.project = function() {
          ...
          var action = TargetResource["::get::Asset::project"];
          return action.apply(R, arguments);
        };
